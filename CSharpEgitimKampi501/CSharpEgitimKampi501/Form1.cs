...
namespace CSharpEgitimKampi501
{
    public partial class Form1 : Form
    {
        ...
        {
            string query = "insert into TblProduct (ProductName,ProductStock,ProductPrice" +
                ",ProductCategory) values (@productName,@productStock,@productPrice,@productCategory)";
            ...
            MessageBox.Show("Yeni Kitap Eklme İşlemi Başarılı!");
        }
